...
- Zdefiniowana funkcja "zna" swoją nazwę (i dużo więcej o sobie). Poniższa funkcja ma też docstring oraz zdefinowane typy wejścia i wyjścia. Zarówno anotacje, jak i magiczne metody zaczynające się od `__` pojawią się dalej na wykładzie.
  ```{python}
  ...
  print(minimum.__name__)
  print(minimum.__doc__)
  print(minimum.__annotations__)
  ```
