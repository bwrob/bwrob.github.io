...
Celem tego ćwiczenia jest praktyczne zastosowanie dziedziczenia w Pythonie do stworzenia hierarchii klas reprezentujących różne typy funkcji matematycznych. Zaimplementujesz klasy dla funkcji rzeczywistych, funkcji różniczkowalnych oraz konkretnego przypadku - funkcji wielomianowych, sinusoidalnych i eksponencjalnych.
...
3.  **Klasa pochodna `PolynomialFunction`:**
    ...
    * Zaimplementuj metodę `__str__(self)`, która zwraca opis wielomianu bazując się na jego współczynnikach. Powinna ona tworzyć łańcuch znaków reprezentujący wielomian w standardowej formie (np. `3x^2 - 2x + 1`).
...
4.  **Klasa pochodna `SineFunction`:**
    ...
    * Zaimplementuj metodę `__str__(self)`, która zwraca opis funkcji sinus bazując się na jej parametrach (amplituda, częstotliwość, faza).
...
5.  **Klasa pochodna `ExponentialFunction`:**
    ...
    * Zaimplementuj metodę `__str__(self)`, która zwraca opis funkcji eksponencjalnej bazując się na jej podstawie.
