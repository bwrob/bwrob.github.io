...
In this post, we'll look at what it's actually like for a mathematician to work in finance. We'll go over the different roles you can land, the skills you actually need (beyond just knowing your way around a proof), and how to navigate the industry.
...
*   **Productionalizing the Code:** The QD takes the messy Jupyter notebook and refactors it into clean, structured, and reusable code. This means introducing classes, static typing (with `mypy`), proper linting, docstrings, and a comprehensive suite of unit and regression tests.
...
During and after my talk at the University of Wrocław, students asked several very interesting questions. Here they are, along with my answers, to help shed more light on the realities of this job:
...
* **Starting the day (approx. 2h):** I begin with code review. I am responsible for the technical quality and design consistency of the code written by quants and less experienced developers.
...
I'll answer this from the perspective of a Quant Developer (since I wasn't a particularly great research quant, so I faced even more challenges there!).
