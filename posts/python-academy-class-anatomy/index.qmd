...
Objects usually need to do more than just hold data. **Instance methods** are functions defined inside a class that operate on its instances. The first parameter is always `self`, referring to the specific object calling the method.
