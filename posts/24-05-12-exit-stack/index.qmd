...
categories: [Pythonic Distractions, Financial Markets, Risk Management]
image: ../../assets/images/posts/24-05-12-exit-stack/flowchart.png
format-links: [html]
---
...
2. Clean up after the OTC products definition is complete.
3. Clean up after the portfolio definition is complśete.
...
1. This is a Pythonic way of disregarding outputs of `some_function`. Method `pop_all` actually moves the stack contents to a new stack, but we don't care about that. We just want to get rid of them from our current one.
...
::: callout-note
Download the whole code [here](../../assets/python/dynamic_context_management_with_exitstack.py).
:::
