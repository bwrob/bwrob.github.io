...
If we know we're never going to use all of the resources, we should clean up the server artifacts artifacts after receving the results. So for each resource we should have a CM.
