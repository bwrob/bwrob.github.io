...
date: "2026-04-05"
categories: [Python, Data Science, Polars]
...
ts_df.with_columns(
    rolling_mean = pl.col("petal_length").rolling_mean(window_size="3d", by="time")
).head(5)
...
::: callout-note
Download the companion script [here](polars_cheat_sheet.py).
:::
