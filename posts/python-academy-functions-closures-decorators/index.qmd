...
In this part of the [Python Academy](https://bwrob.github.io/#category=Python%20Academy), we'll look at how Python's functions work. We'll start with the basics and then check out some more advanced topics like closures and decorators. Getting a handle on these concepts will help you write cleaner and more efficient Python code.
