...
In this post of [Python Academy](https://bwrob.github.io/#category=Python%20Academy), we will explore different ways to calculate Fibonacci numbers in Python. We will start with a naive recursive approach, and then move to more efficient methods.
...
perfplot.show(
    ...
    n_range=[2**i if i < 10 else 2 ** (2 * i) for i in range(15)],
    xlabel="n",
    labels=[
        "iterative (native)",
        "iterative (numba jit)",
