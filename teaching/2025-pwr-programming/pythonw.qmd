...
1. **Wpisz lokalizację elementu**: W polu "Wpisz lokalizację elementu:" wpisz następującą ścieżkę, zastępując odpowiednie fragmenty:
...
1. **Nazwij skrót**: Kliknij "Dalej", a następnie wpisz nazwę dla swojego skrótu (np. "Moja Niesamowita Gra").
...
1. **Lokalizacja pliku ikony**: Umieść plik `.ico` w bezpiecznym miejscu, najlepiej w folderze z grą lub w osobnym folderze `ikony` w katalogu projektu, aby nie został przypadkowo usunięty.
