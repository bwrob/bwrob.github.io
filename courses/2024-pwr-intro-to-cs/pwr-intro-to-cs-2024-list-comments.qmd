...
*  `accumulate` bierze coś po czym można iterować i operator binarny (domyślnie `+`) i zwraca generator częściowych wartości używania tego operatora na wszystkich elementach generatora.
*  `list` tworzy listę zawierająca elementy złożonego generatora, zmusza do materializacji wyników. Wszystko powyżej było tworzone leniwie.
